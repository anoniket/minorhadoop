...
# process = Popen('/home/aniketkhand/Downloads/work/hadoop-2.7.2/bin/hdfs.sh dfs -ls /user/flume/tweets', shell=True, stdout=PIPE, stderr=PIPE)
...
# import sh
# hdfsdir = '/home/aniketkhand/Downloads/work/hadoop-2.7.2/bin/./hdfs.sh'
...
def get_json_object():
    ...
    for a in client.copyToLocal(['/user/flume/tweets/merged_20210102123709.json'], '/home/aniketkhand/Downloads/BGD/final_python_scripts/merged_data'):
        print(a)


    # with open('/home/aniketkhand/Downloads/merged_20210101142527.json') as f:
    #     raw_data = f.read().splitlines()[-1]
    #     list_data = f'[{raw_data}]'
    #     json_data = json.loads(list_data)
    #     print(json_data)

    json_file =  open('/home/aniketkhand/Downloads/BGD/final_python_scripts/merged_data/merged_20210102123709.json')
